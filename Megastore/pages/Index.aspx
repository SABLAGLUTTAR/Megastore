...
<asp:Content ID="Content4" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="White" Width ="100%" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="productsData" ForeColor="Black" GridLines="Vertical">
